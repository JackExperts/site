            ...
            $ajax(API_URL, {
                ...
                .done(function (responseText) {
                    try {
                        ...
                        defer.reject("Resposta incorreta do servidor");
                    }
                })
                .fail(function () {
                    var error = "Falha ao se comunicar com o servidor. ";
                    if ("onLine" in navigator && !navigator.onLine) error += "Sem conexão com a internet";
                    else error += " cheque sua conexão e tente novamente";
                    defer.reject(error);
                });
            return defer;
        };
